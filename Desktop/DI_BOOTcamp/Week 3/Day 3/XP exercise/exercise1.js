...
// #3
function funcFour() {
    window = "hello";   // Note: window only exists in browser
}
function funcFive() {
    console.log(`inside the funcFive function ${typeof a !== 'undefined' ? a : 'undefined'}`);
}
funcFour();
funcFive(); 
...
(function(children, partner, location, job) {
    ...
    console.log(message);
})(3, "Emma", "Nairobi", "Software Developer");
...
(function(userName) {
    ...
    // In browser this would add a navbar, here we just log
})( "Calvin" );
